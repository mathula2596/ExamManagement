<%@ Page Language="C#" AutoEventWireup="true" CodeFile="results_page.aspx.cs" Inherits="results_page" %>
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
                   ...
                   <asp:Panel ID="Panel2" runat="server" BackColor="WhiteSmoke">
                       ...
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       <asp:Label ID="Label5" runat="server" Text="Mathula"></asp:Label>
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                       
                       <br />
                       <br />
                       <br />
                       <asp:Label ID="Label14" runat="server" Font-Bold="False" Font-Overline="False" 
                           Text="Course :"></asp:Label>
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       <asp:Label ID="Label15" runat="server" Font-Bold="False" Font-Overline="False" 
                           Text="DAD"></asp:Label>
                       <br />
                       <br />
                       <asp:Label ID="Label6" runat="server" Font-Bold="False" Font-Overline="False" 
                           Text="Your Grade :"></asp:Label>
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       ...
                       <asp:Label ID="Label7" runat="server" Font-Bold="False" Font-Overline="False" 
                           Text="Correct Answered : "></asp:Label>
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       ...
                       <asp:Label ID="Label8" runat="server" Font-Bold="False" Font-Overline="False" 
                           Text="Skipped Answered  :"></asp:Label>
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       <asp:Label ID="Label12" runat="server" Font-Bold="False" Font-Overline="False" 
                           Text="0"></asp:Label>
                       <br />
                       <br />
                       <asp:Label ID="Label9" runat="server" Font-Bold="False" Font-Overline="False" 
                           Text="Wrong Answered :"></asp:Label>
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       <asp:Label ID="Label13" runat="server" Font-Bold="False" Font-Overline="False" 
                           Text="2"></asp:Label>
                       <br />
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       <br />
                       <asp:Button ID="Button1" runat="server" Text="Ok" CssClass="btn-primary" />
                       <br />
                       <br />
                       <br />
                       <br />
