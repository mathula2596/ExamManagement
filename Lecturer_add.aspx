<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Lecturer_add.aspx.cs" Inherits="Lecturer_add" %>
                       ...
                       <table class="auto-style3" align="center">
                           <tr>
                               <td align="center" class="auto-style18" colspan="3">
                                   <h5><strong>Add Lecturer</strong></h5>
                               </td>
                               <tr>
                               ...
                               <tr>
                                   ...
                                   <td class="auto-style15">
                                       <asp:TextBox ID="txtmobile" runat="server" required="" Width="201px"></asp:TextBox>
                                   </td>
                               </tr>
                               <tr>
                                   <td class="auto-style11"></td>
                                   <td class="auto-style11">NIC :</td>
                               ...
                               <tr>
                                   ...
                                   <td class="auto-style10">
                                       <asp:Button ID="Button1" runat="server" Font-Size="12pt" 
                                           OnClick="Button1_Click" Text="Submit" Height="28px" />
                                   </td>
                               </tr>
                           </tr>
