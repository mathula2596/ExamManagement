<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view_module.aspx.cs" Inherits="view_module" %>
		...
		<div class="row">
			<div class="col-lg-12">
			    ...
			    <asp:Panel ID="Panel1" runat="server" Height="399px">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <br />
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="14pt" Text="Manage Module Details"></asp:Label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <br />
                    <div class="text-left">
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="mo" Height="229px" Width="1047px">
                            <Columns>
                                <asp:BoundField DataField="id" HeaderText="Module ID" ReadOnly="True" SortExpression="id" />
                                <asp:BoundField DataField="course_id" HeaderText="Course ID" SortExpression="course_id" />
                                <asp:BoundField DataField="Expr1" HeaderText="Course Name" SortExpression="Expr1" />
                                <asp:BoundField DataField="name" HeaderText="Module Name" SortExpression="name" />
                                <asp:CommandField ButtonType="Button" HeaderText="Edit/Delete" ShowDeleteButton="True" ShowEditButton="True" />
                            </Columns>
                        </asp:GridView>
                        <asp:SqlDataSource ID="mo" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [module] WHERE [id] = @original_id AND (([course_id] = @original_course_id) OR ([course_id] IS NULL AND @original_course_id IS NULL)) AND (([name] = @original_name) OR ([name] IS NULL AND @original_name IS NULL))" InsertCommand="INSERT INTO [module] ([id], [course_id], [name]) VALUES (@id, @course_id, @name)" SelectCommand="SELECT module.id, module.course_id, module.name, course.name AS Expr1 FROM module INNER JOIN course ON module.course_id = course.Id" UpdateCommand="UPDATE [module] SET [course_id] = @course_id, [name] = @name WHERE [id] = @original_id AND (([course_id] = @original_course_id) OR ([course_id] IS NULL AND @original_course_id IS NULL)) AND (([name] = @original_name) OR ([name] IS NULL AND @original_name IS NULL))">
                            <DeleteParameters>
