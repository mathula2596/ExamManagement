<%@ Page Language="C#" AutoEventWireup="true" CodeFile="contact.aspx.cs" Inherits="Moderna_contact" %>
					...
					<div class="col-md-8 col-md-offset-2">
						...
						<form id="form1" runat="server">
							<div class="form-group">
							    ...
							    <asp:TextBox ID="txtname" runat="server" class="form-control">Your Name</asp:TextBox>
							</div>
							<div class="form-group">
								&nbsp;<div class="validation"></div>
							    <asp:TextBox ID="txtemail" runat="server" class="form-control">Your Email</asp:TextBox>
							</div>
							<div class="form-group">
								&nbsp;<div class="validation"></div>
							    <asp:TextBox ID="txtsubject" runat="server"  class="form-control">Subject</asp:TextBox>
							</div>
							<div class="form-group">
								&nbsp;<div class="validation"></div>
							    <asp:TextBox ID="txtmessage" runat="server"  class="form-control" Height="157px" TextMode="MultiLine" >Message</asp:TextBox>
							</div>

							<div class="text-center">
                                <asp:Button ID="Button1" runat="server" BackColor="#68A4C4" ForeColor="White" OnClick="Button1_Click1" Text="SEND MESSAGE" />
                            </div>
						</form>
					</div>
				</div>
