<%@ Page Language="C#" AutoEventWireup="true" CodeFile="question_add.aspx.cs" Inherits="question_add" %>
                       ...
                       <table class="auto-style3" align="center">
                           <tr>
                               <td align="center" class="auto-style18" colspan="3">
                                   <h5><strong>Add Questions</strong></h5>
                               </td>
                               <tr>
                                   <td class="auto-style5">&nbsp;</td>
                                   <td class="auto-style12">LECTURER ID :</td>
                                   <td class="auto-style6">
                                       <asp:TextBox ID="txtlecid" runat="server" required="" Width="199px"></asp:TextBox>
                                   </td>
                               </tr>
                               <tr>
                                   ...
                                   <td class="auto-style8">
                                       <asp:TextBox ID="txtlecname" runat="server" required="" Width="201px"></asp:TextBox>
                                   </td>
                               </tr>
                               <tr>
                                   ...
                                   <td class="auto-style8">
                                       <asp:DropDownList ID="cmbcourse" runat="server" OnSelectedIndexChanged="cmbgender_SelectedIndexChanged">
                                       </asp:DropDownList>
                                   </td>
                               </tr>
                               <tr>
                                   ...
                                   <td class="auto-style15">
                                       <asp:TextBox ID="txtdate" runat="server" required="" Width="201px" ReadOnly="True"></asp:TextBox>
                                   </td>
                               </tr>
                               <tr>
                                   ...
                                   <td class="auto-style11">
                                       <asp:TextBox ID="txtquestion" runat="server" Height="54px" TextMode="MultiLine" Width="198px"></asp:TextBox>
                                   </td>
                               </tr>
                               <tr>
                                   <td class="auto-style9"></td>
                                   <td class="auto-style9">ANSWER 1 :</td>
                                   <td class="auto-style9">
                                       <asp:TextBox ID="txtanswer1" runat="server" required="" Width="201px"></asp:TextBox>
                                   </td>
                               </tr>
                               <tr>
                                   <td class="auto-style8"></td>
                                   <td class="auto-style8">ANSWER 2 :</td>
                                   <td class="auto-style8">
                                       <asp:TextBox ID="txtanswer2" runat="server" required="" Width="201px"></asp:TextBox>
                                   </td>
                               </tr>
                               <tr>
                                   ...
                                   <td class="auto-style16">
                                       <br />
                                       <asp:TextBox ID="txtanswer3" runat="server" required="" Width="201px"></asp:TextBox>
                                   </td>
                               </tr>
                               <tr>
                                   <td class="auto-style1">&nbsp;</td>
                                   <td class="auto-style1">ASNWER 4 :</td>
                                   <td class="auto-style1">
                                       <asp:TextBox ID="txtanswer4" runat="server" Width="199px"></asp:TextBox>
                                   </td>
                               </tr>
                               <tr>
                                   <td class="auto-style1"></td>
                                   <td class="auto-style1">CORRECT ANS : </td>
                                   <td class="auto-style1">
                                       <asp:DropDownList ID="cmbanswer" runat="server" Height="26px" Width="206px">
                                           <asp:ListItem>Select the correct answer</asp:ListItem>
