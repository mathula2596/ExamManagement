<%@ Page Language="C#" AutoEventWireup="true" CodeFile="course_add.aspx.cs" Inherits="course_add" %>
...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Course<asp:Panel ID="Panel1" runat="server" Height="399px">
              
                <table style="width:100%;">
                    <tr>
                        <td colspan="2" align="center">       
                          
                                <asp:Label ID="Label2" runat="server" Font-Size="Large" Text="Add Courses" CssClass="auto-style2"></asp:Label>
                    ...
                    <tr>
                        ...
                        <td>  
                                ...
                                <asp:TextBox ID="txtid" runat="server" required="" Width="199px" CssClass="auto-style3"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>  
                                ...
                                <asp:TextBox ID="txtname" runat="server" required="" Width="199px" CssClass="auto-style3"></asp:TextBox>
                        ...
                        <td align="right">
                                ...
                                <span class="auto-style1">Duration :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
                        </td>
                        <td>  
                        
                                <asp:TextBox ID="txtduration" runat="server" required="" Width="199px" CssClass="auto-style3"></asp:TextBox>
                    ...
                    <tr>
                        <td align="right">
                                ...
                                <span class="auto-style1">Payment :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
                        </td>
                        <td>  
                        
                                <asp:TextBox ID="txtpayment" runat="server" required="" Width="199px" CssClass="auto-style3"></asp:TextBox>
                    ...
                    <tr>
                        <td align="right">&nbsp;</td>
                        <td>
                            <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Submit" Font-Size="14pt" />
                            <br />
                        </td>
                    </tr>
                </table>
