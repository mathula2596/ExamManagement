				...
				<div class="row">
                   ...
                   <asp:Panel ID="Panel1" runat="server" BackColor="WhiteSmoke">
					<br />
                       ...
                       <br />
                       <asp:RadioButton ID="rdbadmin" runat="server" Text="Admin" name="pos" GroupName="pos"/>
&nbsp;&nbsp;<strong>&nbsp;</strong><asp:RadioButton ID="rdblecturer" runat="server" Text="Lecturer" name="pos"  GroupName="pos"/>
                       <br />
                       <h5>
                       ...
                       <h5>
                           &nbsp;<asp:Button ID="Button3" runat="server" Text="Login" OnClick="Button3_Click1" />
                           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
