<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lec_dash.aspx.cs" Inherits="lec_dash" %>
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<ul class="nav navbar-top-links navbar-right">
				    ...
				    <li>
                        <asp:Label ID="lbluser" runat="server" ForeColor="White" Text="Label"></asp:Label>
                    </li>
				</ul>
			</div>
		</div><!-- /.container-fluid -->
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<div class="profile-sidebar">
			...
			<div class="profile-usertitle">
				<div class="profile-usertitle-name">L1001</div>
		...
		<div class="row">
			<div class="col-lg-12">
			    ...
			    <asp:Panel ID="Panel1" runat="server" Height="399px">
                    ...
                    <br />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Label ID="Label1" runat="server" Text="Welcome to the XYZ Institute" Font-Bold="True" Font-Names="Lemon" Font-Size="XX-Large"></asp:Label>
                </asp:Panel>
			</div>
		</div><!--/.row-->
