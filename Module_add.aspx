...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Modules<asp:Panel ID="Panel1" runat="server" Height="399px">
              
                <table style="width:100%;">
                    <tr>
                        <td colspan="2" align="center">       
                          
                                <asp:Label ID="Label2" runat="server" Font-Size="Large" Text="Add Module" CssClass="auto-style2"></asp:Label>
                    ...
                    <tr>
                        ...
                        <td>  
                                ...
                                <asp:TextBox ID="txtid" runat="server" required="" Width="258px" 
                                    CssClass="auto-style3" ReadOnly="True"></asp:TextBox>
                    ...
                    <tr>
                        <td align="right">
                                ...
                                <span class="auto-style1">Course ID :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
                        </td>
                        <td>  
                        
                                <asp:TextBox ID="txtcourseid" runat="server" required="" Width="257px" 
                                    CssClass="auto-style3"></asp:TextBox>
                         
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button2" runat="server" Text="Verify" Font-Size="12pt" OnClick="Button2_Click" />
                     ...
                     <tr>
                        <td align="right">
                                ...
                                <span class="auto-style1">Course Name :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
                        </td>
                        <td>  
                        
                                <asp:TextBox ID="txtcoursename" runat="server"  Width="256px" 
                                    CssClass="auto-style3"></asp:TextBox>
                        ...
                        <!--textbox -->
                            <td align="right"><span class="auto-style1">Module Name :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></td>
                            <td>
                                <asp:TextBox ID="txtname" runat="server" CssClass="auto-style3"  Width="256px"></asp:TextBox>
                            </td>
                        <tr>
                            <td align="right">&nbsp;</td>
                            <td>
                                <asp:Button ID="Button1" runat="server" Text="Submit" Font-Size="12pt" OnClick="Button1_Click" />
                                <br />
                            </td>
                        </tr>
                </table>
