<%@ Page Language="C#" AutoEventWireup="true" CodeFile="panels.aspx.cs" Inherits="panels" %>
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li><a href="dash.aspx"><em class="fa fa-dashboard">&nbsp;</em> Dashboard</a></li>
			...
			<li class="active"><a href="panels.aspx"><em class="fa fa-clone">&nbsp;</em> Alerts &amp; Panels</a></li>
